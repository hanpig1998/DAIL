...
parser.add_argument('--memory-budgets', type=int, nargs='+', default=[1000],
    ...
    for at in args.alphas:
        ...
        for m in args.memory_budgets:
            ...
            for class_group in range(0, dataset.classes, args.step_size):
                ...
                with open('results/1_'+str(args.seeds)+'.txt', 'a') as f:
                    f.write("class_group: "+str(class_group)+" Test Classifier Final: "+str(t_classifier.evaluate(my_trainer.model, test_iterator))+"\n", )
